...
export default function Shop() {
        ...
        <div className='shopList'>
            ...
            <div className='list-section'>
                ...
                <div className='list-products'>
                    <div className='filter-order c-center'>
	...
	C1.62,1.84,1.58,1.78,1.62,1.7c0.03-0.1,0.11-0.1,0.14-0.1h12.5c0.02,0,0.1,0,0.14,0.1C14.42,1.78,14.38,1.84,14.35,1.86z"/>
                        ...
                        <div className='flex'>
                            {/* <button className='icon cans' title='فرز آفقي' disabled>
                                <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" viewBox="0 0 18 18" className='icon-selected'>
                                    <path d="M17,11H1c-0.55,0-1-0.45-1-1V8c0-0.55,0.45-1,1-1h16c0.55,0,1,0.45,1,1v2C18,10.55,17.55,11,17,11z M17,14H1
	c-0.55,0-1,0.45-1,1v2c0,0.55,0.45,1,1,1h16c0.55,0,1-0.45,1-1v-2C18,14.45,17.55,14,17,14z M17,0H1C0.45,0,0,0.45,0,1v2
	c0,0.55,0.45,1,1,1h16c0.55,0,1-0.45,1-1V1C18,0.45,17.55,0,17,0z"/>
	...
	C19,12.9,18.1,12,17,12z M17,1h-3c-1.1,0-2,0.9-2,2v3c0,1.1,0.9,2,2,2h3c1.1,0,2-0.9,2-2V3C19,1.9,18.1,1,17,1z"/>
                    ...
                    <div className='filter-result'>
                        <div className='filter-resultDsn'>
                            عدد النتائج <div className='space-10'></div>< div className='filter-count'>{count.count}</div>
                        </div>
                    </div>
                    {isOpenFilter && (
...
L2.82,11.29z M7.82,13.37V9.22l3.59,2.07l0,0L7.82,13.37z"/>
     ...
     c0.55,0,1.03-0.35,1.2-0.87L7.8,2.2C8.18,1.04,9.82,1.04,10.2,2.2z"/>
                                    ...
                                    {!service.is_saved ? (
                                        <div className='flex fwid h-center'>
                                            <form onSubmit={(e) => basketSubmet(service.title, service.product_id, e)}>
             ...
             C8.1,7.94,8.5,8.34,9,8.34z"/>
                                            ...
                                            <div className='space-10'></div>
                                            <form onSubmit={(e) => saveSubmit(service.title, service.product_id, e)}>
